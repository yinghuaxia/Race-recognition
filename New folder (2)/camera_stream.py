...
class CameraStream:
    def __init__(self,camera_idx,video_hw=[960,540],show=False,save_dir=""):
        self._camera_idx=camera_idx
        self._video_hw=[1280,720]
    ...
    def _FrameStream(self,self2process_queue,process2self_queue,stopsignal_queue):
        ...
        # camera_capture = cv2.VideoCapture(r'WIN_20240826_11_22_43_Pro.mp4')
        ...
        output_path = r'C:\Users\HW PA\Desktop\Small_Jenny/jj_LowLight.mp4'
        fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # 指定影片編碼格式
        out = cv2.VideoWriter(output_path, fourcc, 30, (1920, 1080))
        # print(video_hw[0], video_hw[1])
        data_dict={}
        ...
        while(1):
            ...
            if(show_bool==True):
                ...
                if(type(cur_bboxes)!=type(None)):
                    show_frame=Drawing(show_frame,cur_bboxes,thickness=3)
                # print(show_frame.shape[0], show_frame.shape[1])
