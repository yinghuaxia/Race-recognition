...
class CSLLoss(tf.Module):
    ...
    def _BboxesLoss(self,true_y,pred_y,true_mask,true_wht):
        ...
        # print("box_for_fit_true",box_for_fit_true.shape)
        # print("box_for_fit_pred",box_for_fit_pred.shape)

        true_wh=true_y[...,6:8]
        coord_loss_scale=2-true_wh[...,0]*true_wh[...,1]
   
        # print("true_wh",true_wh.shape)
        # print("coord_loss_scale",coord_loss_scale.shape)
        # print("box_for_fit_true[...,:2]",box_for_fit_true[...,:2].shape)
        # print("box_for_fit_pred[...,:2]",box_for_fit_pred[...,:2].shape)
