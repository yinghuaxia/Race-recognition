...
class CSLBone(Module):
    def _Build(self,input_shapes):
        self._conv=Conv(4,(3,3),(2,2))
        self._cslblck_1=CSLBlock(4,1,1.0,1)
        self._cslblck_2=CSLBlock(8,1,0.5,1)
        self._cslblck_3=CSLBlock(12,1,0.5,1)
        self._cslblck_4=CSLBlock(18,1,0.5,1)
        self._cslblck_5=CSLBlock(24,1,0.5,1)
        self._cslblck_6=CSLBlock(36,1,0.5,2)
        ...
        # self._cslblck_5=CSLBlock(192,3,1,6)
